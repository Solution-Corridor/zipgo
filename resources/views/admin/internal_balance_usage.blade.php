        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Internal Balance Usage</h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-header">
                                    <h3 class="card-title">Internal Balance Usage</h3>
                                            ...
                                            @forelse ($transactions as $transaction)
                                                <tr>
                                                    ...
                                                    <td class="{{ $transaction->amount >= 0 ? 'text-success' : 'text-danger' }}">
                                                        {{ $transaction->amount >= 0 ? '' : '' }}{{ number_format($transaction->amount, 0) }} Rs
                                                        @php
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td colspan="2" class="text-left font-weight-bold">
                                                    Total Amount: {{ number_format($totalShares, 0) }} Rs
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
