                                                ...
                                                <tbody>
                                                    @forelse ($todayTrx as $trx)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="badge {{ $trx->trx_type === 'spin_win' ? 'badge-success' : 'badge-danger' }}">
                                                                    {{ $trx->trx_type === 'spin_win' ? 'WIN' : 'BET' }}
                                                                </span>
                                                            </td>
                                                            <td class="{{ $trx->trx_type === 'spin_win' ? 'text-success fw-bold' : 'text-danger' }}">
                                                ...
                                                <div class="col-6">
                                                    <div class="info-box bg-warning">
                                                        ...
                                                        <div class="info-box-content">
                                                            ...
                                                            <span class="progress-description">
                                                                {{ $allSummary['wins']['count'] }} wins out of {{ $allSummary['total']['count'] }} total spins
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
