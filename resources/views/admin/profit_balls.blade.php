                                                ...
                                                <tbody>
                                                    @forelse ($todayTrx as $trx)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="badge {{ $trx->trx_type === 'profit_balls_win' ? 'badge-success' : 'badge-danger' }}">
                                                                    {{ $trx->trx_type === 'profit_balls_win' ? 'WIN' : 'BET' }}
                                                                </span>
                                                            </td>
                                                            <td class="{{ $trx->trx_type === 'profit_balls_win' ? 'text-success fw-bold' : 'text-danger' }}">
                                                    ...
                                                    @empty
                                                        <tr>
                                                            <td colspan="6" class="text-center text-muted py-5">
                                                                <i class="fas fa-info-circle me-2"></i>No profit balls transactions recorded for today yet
                                                            </td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
                                                ...
                                                <div class="col-lg-4 col-6">
                                                    <div class="small-box bg-info">
                                                        <div class="inner">
                                                            ...
                                                            <p>Total Profit Balls (All Time)</p>
                                                        </div>
                                                        <div class="icon">
                                                            <i class="fas fa-spinner"></i>
                                                        </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="info-box bg-warning">
                                                        ...
                                                        <div class="info-box-content">
                                                            ...
                                                            <span class="progress-description">
                                                                {{ $allSummary['wins']['count'] }} wins out of {{ $allSummary['total']['count'] }} total profit balls
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
