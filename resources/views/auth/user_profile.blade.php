					...
					<div class="col-md-3">
						<div class="margin-bottom-20"> 
							<div class="utf-edit-profile-photo-area"> 
								<img src="/profile/{{ $user['pic'] }}" onerror="this.src='/images/avatar.png'" alt="Avatar">

								<div class="utf-change-photo-btn-item">
									<div class="utf-user-photo-upload"> <span><i class="fa fa-upload"></i> Upload Photo</span>
										<input type="file" name="pic" class="upload tooltip top" title="Upload Photo" />
									</div>
								</div>
					...
					<div class="col-md-9">
						...
						<div class="row mb-2">
							...
							<div class="col-md-4">
								...
								<input type="text" name="ref_code" class="form-control" value="{{$user['ref_code']}}" disabled>
							</div>
							...
							<div class="col-md-12 text-center">
								<button type="submit" class="button border">Update Profile</button>
							</div>
