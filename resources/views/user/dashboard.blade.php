...
<body class="min-h-screen bg-[#0A0A0F]">
  ...
  <div class="mx-auto max-w-[420px] min-h-screen bg-[#0A0A0F] shadow-2xl shadow-black/50 relative">
    ...
    <div class="flex gap-2 px-4 mb-5">
      <a href="/plan" class="flex-1 py-1.5 rounded-full font-medium text-xs bg-gradient-to-r from-emerald-500 to-green-600 text-white shadow-md hover:brightness-110 active:scale-95 transition-all text-center">Membership</a>
      <a href="#" class="flex-1 py-1.5 rounded-full font-medium text-xs bg-gradient-to-r from-indigo-500 to-blue-600 text-white shadow-md hover:brightness-110 active:scale-95 transition-all text-center">Upgrade Plan</a>
    </div>
    ...
    <div class="grid grid-cols-3 gap-3 px-4 mb-4">
      <a href="/my-plans" class="card rounded-xl p-3 text-center hover:scale-105 active:scale-95 transition"><div class="mx-auto mb-1.5 w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-600 to-purple-800 flex items-center justify-center"><i data-lucide="layers" class="w-5 h-5"></i></div><p class="font-semibold text-xs">My Plans</p></a>
      <a href="/invite" class="card rounded-xl p-3 text-center hover:scale-105 transition"><div class="mx-auto mb-1.5 w-10 h-10 rounded-lg bg-gradient-to-br from-purple-600 to-pink-600 flex items-center justify-center"><i data-lucide="users" class="w-5 h-5"></i></div><p class="font-semibold text-xs">My Team</p></a>
      <a href="#" class="card rounded-xl p-3 text-center hover:scale-105 transition relative"><div class="mx-auto mb-1.5 w-10 h-10 rounded-lg bg-emerald-600 flex items-center justify-center"><i data-lucide="list-checks" class="w-5 h-5 text-white"></i></div><p class="font-semibold text-xs mt-1.5">My Tasks</p><span class="absolute -top-1 -right-1 bg-amber-600 text-[9px] font-bold px-1.5 py-0.5 rounded-full shadow"></span></a>
      <a href="/my-orders" class="card rounded-xl p-3 text-center hover:scale-105 transition"><div class="mx-auto mb-1.5 w-10 h-10 rounded-lg bg-gradient-to-br from-green-600 to-emerald-700 flex items-center justify-center"><i data-lucide="shopping-cart" class="w-5 h-5"></i></div><p class="font-semibold text-xs">My Orders</p></a>
      <a href="/withdraw-history" class="card rounded-xl p-3 text-center hover:scale-105 transition"><div class="mx-auto mb-1.5 w-10 h-10 rounded-lg bg-gradient-to-br from-red-600 to-rose-700 flex items-center justify-center"><i data-lucide="upload" class="w-5 h-5"></i></div><p class="font-semibold text-xs">Withdraw Log</p></a>
      <a href="/FeatureDesk.apk" class="card rounded-xl p-3 text-center hover:scale-105 transition"><div class="mx-auto mb-1.5 w-10 h-10 rounded-lg bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center"><i data-lucide="smartphone" class="w-5 h-5"></i></div><p class="font-semibold text-xs">App Download</p></a>
      <a href="{{ route('my_complaints') }}" class="card rounded-xl p-3 text-center hover:scale-105 transition"><div class="mx-auto mb-1.5 w-10 h-10 rounded-lg bg-amber-600 flex items-center justify-center"><i data-lucide="alert-circle" class="w-5 h-5 text-white"></i></div><p class="font-semibold text-xs">Complaint</p></a>
      <a href="/all-transactions" class="card rounded-xl p-3 text-center hover:scale-105 transition"><div class="mx-auto mb-1.5 w-10 h-10 rounded-lg bg-gradient-to-br from-blue-600 to-cyan-600 flex items-center justify-center"><i data-lucide="receipt" class="w-5 h-5"></i></div><p class="font-semibold text-xs">Transactions</p></a>
      <a href="https://whatsapp.com/channel/0029VbCEe3o0lwgyDdnKFe1H" rel="noopener noreferrer" class="card rounded-xl p-3 text-center hover:scale-105 transition"><div class="mx-auto mb-1.5 w-10 h-10 rounded-lg bg-green-600 flex items-center justify-center"><i class="fab fa-whatsapp w-5 h-5 text-white"></i></div><p class="font-semibold text-xs">Helpline</p></a>
    </div>
