...
<div class="w-full max-w-[420px] min-h-screen relative" style="background: #0B0B12;">
    ...
    <div class="px-5 " style="padding-bottom: 90px;">
        ...
        <div class="w-full max-w-md mx-auto px-4 pt-1 pb-6">  <!-- reduced pb from 10 to 6 -->
            ...
            <div class="grid grid-cols-3 sm:grid-cols-4 gap-2 mb-4 auto-rows-fr">
                @foreach([50, 100, 200, 500, 1000, 2000, 3000, 4000, 5000, 8000, 10000] as $amount)
                    <button 
                        type="button"
                        ...
                        data-amount="{{ $amount }}"
                        {{ $amount > (auth()->user()->balance ?? 0) ? 'disabled' : '' }}
                    >
    ...
    @include('user.includes.bottom_navigation')  <!-- if this has internal padding, consider reducing it (e.g., py-1 instead of py-2) -->
