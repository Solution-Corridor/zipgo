									...
									<div class="row">
										...
										<div class="col-lg-12 ">
											<div class="form-group">
												<input name="name" type="text" class="form-control" required data-error="Please enter your Username"  value="{{$user['name']}}"  placeholder="Enter Your Username " >
                                                @error('name')
										...
										<div class="col-lg-12 ">
											<div class="form-group">
												<input type="email" name="email" class="form-control" required data-error="Please enter your Username or Email" value="{{$user['email']}}" placeholder="Enter Your Email">
                                                @error('email')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
										...
										<div class="col-12">
											<div class="form-group">
												<input class="form-control" type="number" name="phone" placeholder="Password" value="{{$user['phone']}}"  >
											</div>
										</div>

											<div class="col-lg-12">
											<div class="form-group">
												<select name="country" class="form-control" required data-error="Please Seelct" placeholder=" country">
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<select class="form-control" name="gender" >
													<option value="{{$user['country']}}">{{$user['gender']}}</option>
