...
<head>
  ...
  <style>
    /* === Select2 Dark Theme Overrides (Navy/Gold) === */
      ...
      <div class="mt-2 mb-6">
        ...
        <form action="{{ route('expert.profile.update') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="space-y-6">
            ...
            <button type="submit"
              {{ $canEdit ? '' : 'disabled' }}
              class="w-full py-3.5 rounded-xl font-semibold text-white bg-gradient-to-r from-[#F4A261] to-[#E08E3E] shadow-lg shadow-[#F4A261]/20 transition-all hover:from-[#E08E3E] hover:to-[#D97706] {{ $canEdit ? '' : 'opacity-60 cursor-not-allowed' }}">
