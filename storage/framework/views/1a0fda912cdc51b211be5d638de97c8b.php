    ...
    <script type="application/ld+json">
        {
            ...
            "name": "Feature Desk",
            "url": "<?php echo e(url('/')); ?>",
            "logo": "<?php echo e(asset('mk_assets/images/feature-desk-logo.png')); ?>",
    ...
    <div class="category-item">
        <a href="/<?php echo e($cat->url); ?>">
            <div class="category-img">
                <img src="<?php echo e($cat->feature_image); ?>"
                    onerror="this.onerror=null; this.src='/assets/images/favicon.png';"
                    alt="<?php echo e($cat->category_name); ?>"
                    title="<?php echo e($cat->category_name); ?>">
            </div>
...
?>
    ...
    <?php echo $__env->make('includes.product_card_small', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </section>
...
</html><?php /**PATH E:\xampp\htdocs\zipGo\resources\views/website/index.blade.php ENDPATH**/ ?>