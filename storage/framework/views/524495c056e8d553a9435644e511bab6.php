...
<body class="body body5 bg-[#0A0A0F] text-white">
    ...
    <?php if(session('attempts_left') !== null): ?>
        <p class="text-yellow-400 text-sm font-medium">
            Attempts left: <strong><?php echo e(session('attempts_left')); ?></strong>
        </p>
    <?php endif; ?>

    
</div>
                    <form action="<?php echo e(route('saveRegister')); ?>" method="POST" class="space-y-5">
                        <?php echo csrf_field(); ?>

                        <?php if(isset($ref) && $ref): ?>
                        <input type="hidden" name="referred_by" value="<?php echo e($ref->id ?? ''); ?>">
                        <div class="text-xs text-white/50">Referral code: <?php echo e(request()->code ?? $code ?? ''); ?></div>
...
<div id="username-error" class="text-red-400 text-xs mt-1.5 px-1 min-h-[1.25rem]"></div>
        ...
        <div class="custom-dropdown-menu" id="cityDropdownMenu">
            ...
            <div id="cityOptionsList">
                <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="custom-dropdown-item" data-value="<?php echo e($city->id); ?>">
    ...
    <input type="hidden" name="city_id" id="city_id" value="<?php echo e(old('city_id')); ?>">
</div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    usernameInput.addEventListener('blur', async function() {
        ...
        try {
            const response = await fetch('<?php echo e(route("check.username")); ?>', {
                method: 'POST',
                headers: {
...
</html><?php /**PATH E:\xampp\htdocs\zipGo\resources\views/auth/register.blade.php ENDPATH**/ ?>