                        ...
                        <div class="overflow-y-auto divide-y divide-slate-800/60">
                            <?php if(auth()->guard()->check()): ?>
                                <?php $__empty_1 = true; $__currentLoopData = auth()->user()->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <a href="<?php echo e(route('notification.read', $notification->id)); ?>" class="block px-5 py-3.5 hover:bg-slate-800/40 transition group">
                                        <p class="text-sm text-slate-200 leading-snug group-hover:text-white"><?php echo e($notification->data['message'] ?? 'New notification'); ?></p>
                                        <p class="text-[11px] text-slate-500 mt-1"><?php echo e($notification->created_at->diffForHumans()); ?></p>
                                    </a>
