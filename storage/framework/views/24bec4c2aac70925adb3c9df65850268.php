    ...
    <div class="w-full max-w-[420px] min-h-screen relative" style="background: #0B0B12;">
        ...
        <div class="mb-20 px-4 py-6">
            ...
            <div class="games-grid">
                ...
                <!-- Original 3 Games -->
                <a href="<?php echo e(route('games.burst-numbers')); ?>" class="game-card block">
                ...
                <a href="<?php echo e(route('games.profit-ball')); ?>" class="game-card block">
                ...
                <a href="<?php echo e(route('games.lucky-spin')); ?>" class="game-card block">
...
</html><?php /**PATH E:\xampp\htdocs\FeatureDesk\resources\views/user/games/games.blade.php ENDPATH**/ ?>