    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center h-20">
            ...
            <nav class="hidden md:flex items-center gap-6">
                ...
                <a href="<?php echo e(route('logout')); ?>" style="color: #f70212;"
...
<div id="mobile-menu" class="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm hidden md:hidden">
    ...
    <?php endif; ?>
            ...
            <a href="<?php echo e(route('invite')); ?>" class="flex items-center gap-4 text-white/80 hover:text-primary transition-colors p-3 rounded-lg hover:bg-white/5">Referrals</a>
            <a href="<?php echo e(route('user_profile')); ?>" class="flex items-center gap-4 text-white/80 hover:text-primary transition-colors p-3 rounded-lg hover:bg-white/5">Settings</a>
            <div class="pt-4">
                <a href="<?php echo e(route('logout')); ?>" style="color: #f70212;"
                    class="w-full text-left flex items-center gap-4 text-[#ef4444] hover:text-[#f87171] transition-colors p-3 rounded-lg hover:bg-white/5">
                    Logout
...
</div><?php /**PATH E:\xampp\htdocs\zipGo\resources\views/includes/includes/navbar.blade.php ENDPATH**/ ?>