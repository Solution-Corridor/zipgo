...
<aside class="main-sidebar sidebar-dark-green elevation-4">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="/expert-dashboard" class="nav-link <?php echo e(request()->segment(1) == 'expert-dashboard' ? 'active' : ''); ?>">
                        <i class="nav-icon fas fa-tachometer-alt"></i>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('cities.index')); ?>" class="nav-link <?php echo e(request()->segment(1) == 'cities' ? 'active' : ''); ?>">
                ...
                <li class="nav-item">
                    <a href="" class="nav-link <?php echo e(request()->segment(1) == 'payment-methods' ? 'active' : ''); ?>">
                ...
                <li class="nav-item <?php echo e(in_array(request()->segment(2), ['add_blogs','blogs_list','edit_blog','upload_images']) ? 'menu-open' : ''); ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="" class="nav-link <?php echo e(request()->segment(2) == 'add_blogs' ? 'active' : ''); ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add Blog</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link <?php echo e(in_array(request()->segment(2), ['blogs_list','edit_blog']) ? 'active' : ''); ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Blogs Listing</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="" class="nav-link <?php echo e(in_array(request()->segment(2), ['add_category','edit_category']) ? 'active' : ''); ?>">
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH E:\xampp\htdocs\zipGo\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>