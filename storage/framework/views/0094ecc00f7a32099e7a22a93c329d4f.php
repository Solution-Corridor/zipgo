...
<body class="min-h-screen bg-[#0A0A0F]">
    ...
    <div class="mx-auto max-w-[420px] min-h-screen bg-[#0A0A0F] shadow-2xl shadow-black/50 relative">
        ...
        <div class="px-5 pt-6 pb-28 flex flex-col min-h-[60vh]">
                    ...
                    <div class="px-4 py-1 flex items-center justify-between relative gap-3">
                        ...
                        <div class="text-center flex-1">
                            ...
                            <p class="text-lg md:text-lg font-bold text-emerald-400 tracking-tight">
                                <?php echo e(max(0, $totalDailyTasks - $todayClaimedCount)); ?>

                            </p>
                            <p class="text-[10px] text-gray-400 mt-0.5">out of <?php echo e($totalDailyTasks); ?></p>
                        </div>
                        ...
                        <div class="text-center flex-1">
                            ...
                            <p class="text-lg md:text-lg font-bold text-emerald-400 tracking-tight">
                                Rs <?php echo e(number_format($todayClaimedAmount,0)); ?>

                            </p>
                            <p class="text-[10px] text-gray-400 mt-0.5">Tasks: <?php echo e($todayClaimedCount); ?></p>
                        </div>
                        ...
                        <div class="text-center flex-1">
                            ...
                            <p class="text-lg md:text-lg font-bold text-emerald-400 tracking-tight">
                                <?php echo e($activePayments->count()); ?>
            ...
            <?php if(!$canClaimNow): ?>
            <?php $firstTask = $allTasks->first(); ?>
            <?php if($firstTask): ?>
            <div class="hidden" id="firstTaskTimerData" data-time-left="<?php echo e($timeLeftToNext); ?>"></div>
            <?php endif; ?>
            <?php endif; ?>
...
<?php echo e(($loop->first && $canClaimNow) ? 'cursor-pointer active:scale-[0.98]' : 'locked'); ?>"
                    data-task-id="<?php echo e($task->id); ?>"
                    data-duration="<?php echo e($task->duration ?? 30); ?>"
                    data-price="<?php echo e($task->task_price); ?>"
                    data-package-id="<?php echo e($task->package_id ?? ''); ?>"
                    data-payment-id="<?php echo e($task->payment_id ?? ''); ?>"
                    data-file-path="<?php echo e(asset($task->file_path)); ?>"
                    data-name="<?php echo e($task->name ?? 'Task #' . $task->id); ?>"
                    onclick="<?php echo e(($loop->first && $canClaimNow) ? 'openTask(this)' : 'event.preventDefault()'); ?>">

                    <!-- Reward Badge -->
                    <div class="absolute top-2 right-2 z-10 bg-emerald-600 text-white text-xs font-bold px-2.5 py-1 rounded-full shadow-md">
                        Rs <?php echo e(number_format($task->task_price, 0)); ?>
                    ...
                    <div class="relative h-32 bg-black">
                        <?php if($isVideo): ?>
                        <video src="<?php echo e(asset($task->file_path)); ?>"
                        ...
                        <?php else: ?>
                        <img src="<?php echo e(asset($task->file_path)); ?>"
                            class="w-full h-full object-cover"
                            alt="<?php echo e($task->name ?? 'Task'); ?>">
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="p-3">
                        <div class="flex items-center justify-between text-xs text-gray-300">
                            <div class="flex items-center gap-1.5">
                                <span>⏱</span>
                                <span><?php echo e($task->duration ?? '?'); ?> sec</span>
                            </div>
...
<?php if(!$canClaimNow && isset($firstTask) && $timeLeftToNext > 0): ?>
let timeLeft = Math.floor(<?php echo e($timeLeftToNext); ?>);
...
</html><?php /**PATH E:\xampp\htdocs\FeatureDesk\resources\views/user/my_tasks2.blade.php ENDPATH**/ ?>