...
<main class="mx-auto max-w-md p-4 min-h-screen">
    ...
    <?php echo $__env->make('includes.mob_navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="mt-6 text-center">
                <a href="<?php echo e(route('login')); ?>" class="text-primary hover:text-accent transition-colors">
                    Back to Login
                </a>
            </div>
...
</html><?php /**PATH E:\xampp\htdocs\zipGo\resources\views/auth/forgot_password.blade.php ENDPATH**/ ?>