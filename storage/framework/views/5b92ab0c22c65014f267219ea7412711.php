...
<div class="min-h-screen bg-[#0A0A0F] flex flex-col">
    ...
    <?php endif; ?>
                    ...
                    <form action="<?php echo e(route('postLogin')); ?>" method="post" class="space-y-4">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH E:\xampp\htdocs\FeatureDesk\resources\views/auth/login.blade.php ENDPATH**/ ?>