    ...
    <main class="px-5 pt-1 pb-32">
      ...
      <div class="glass rounded-xl px-4 py-3 mb-4 shadow-md flex items-center justify-between">
        <div>
          ...
          <span class="font-bold ml-1"><?php echo e($plan->name ?? 'Eagle-01'); ?></span>
        </div>

        <div>
          <span class="text-gray-400 text-sm">Amount:</span>
          <span class="text-emerald-400 font-bold ml-1">
            <?php echo e(number_format($plan->investment_amount ?? 445)); ?> Rs
          </span>
        </div>
      </div>
      ...
      <div class="mb-8">
        ...
        <div class="methods-grid 
          ...
          <?php $__empty_1 = true; $__currentLoopData = $activeMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div 
              class="method-card glass"
              data-is-internal="false"
              data-method='<?php echo json_encode($method, 15, 512) ?>'
            >
              <div class="method-logo-container">
                <?php if($method->account_type == 'easypaisa'): ?>
                  <img src="/assets/images/easypaisa.png" alt="Easypaisa" class="method-logo">
                <?php endif; ?>
                <?php if($method->account_type == 'jazzcash'): ?>
                  <img src="/assets/images/jazzcash.png" alt="JazzCash" class="method-logo">
                <?php endif; ?>
                <?php if($method->account_type == 'nayapay'): ?>
                  <img src="/assets/images/nayapay.png" alt="NayaPay" class="method-logo">
                <?php endif; ?>
                <?php if($method->account_type == 'sadapay'): ?>
...
<div id="iban-wrapper" class="hidden flex items-center">
  ...
  <button type="button" class="copy-btn" data-clipboard-target="iban-number" title="Copy IBAN">
    <i data-lucide="copy" class="w-4 h-4"></i>
        ...
        <!-- Confirmation Form -->
        <form action="<?php echo e(route('user.payment.confirm')); ?>" 
              method="POST" 
...
<div id="upload-wrapper" class="mb-3">
  ...
  <script>
    ...
    function selectInternalFunds(element) {
      ...
      document.getElementById('account-number').textContent = "<?php echo e(number_format(auth()->user()->balance ?? 0)); ?> Rs";
      document.getElementById('method-instructions').innerHTML = 
        `You are about to pay <strong><?php echo e(number_format($plan->investment_amount ?? 445)); ?> Rs</strong> using your internal wallet balance.<br><br>` +
...
</html><?php /**PATH E:\xampp\htdocs\FeatureDesk\resources\views/user/get_payment.blade.php ENDPATH**/ ?>